...
def get_flight_list(lookup_date: date, airport: str):
	...
	conn.request("GET", f"/bff/air-offers/offers/search?sort=RECOMMENDED&cabinType=Economy&origin={airport}&destination=IGU&inFlightDate=null&inFrom=null&inOfferId=null&outFlightDate=null&outFrom={date_str}&outOfferId=null&adult=1&child=0&infant=0&redemption=false", payload, headers)
